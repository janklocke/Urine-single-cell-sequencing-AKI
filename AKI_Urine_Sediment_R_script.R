...
## loading data ----
P005.data <- Read10X(data.dir = "~/NR_JK_001/filtered_feature_bc_matrix")
P006.data <- Read10X(data.dir = "~/NR_JK_002/filtered_feature_bc_matrix")
P007.data <- Read10X(data.dir = "~/NR_JK_003/filtered_feature_bc_matrix")
P017.1.data <- Read10X(data.dir = "~/NR_JK_017/filtered_feature_bc_matrix")
P017.2.data <- Read10X(data.dir = "~/NR_JK_018/filtered_feature_bc_matrix")
P018.1.data <- Read10X(data.dir = "~/NR_JK_019/filtered_feature_bc_matrix")
P018.2.data <- Read10X(data.dir = "~/NR_JK_020/filtered_feature_bc_matrix")
P019.1.data <- Read10X(data.dir = "~/NR_JK_021/filtered_feature_bc_matrix")
P019.2.data <- Read10X(data.dir = "~/NR_JK_022/filtered_feature_bc_matrix")
P021.data <- Read10X(data.dir = "~/NR_JK_035/filtered_feature_bc_matrix")
P022.data <- Read10X(data.dir = "~/NR_JK_036/filtered_feature_bc_matrix")
P023.1.data <- Read10X(data.dir = "~/NR_JK_038/filtered_feature_bc_matrix")
P023.2.data <- Read10X(data.dir = "~/NR_JK_041/filtered_feature_bc_matrix")
P023.3.data <- Read10X(data.dir = "~/NR_JK_042/filtered_feature_bc_matrix")
P023.4.data <- Read10X(data.dir = "~/NR_JK_044/filtered_feature_bc_matrix")
P024.1.data <- Read10X(data.dir = "~/NR_JK_043/filtered_feature_bc_matrix")
P024.2.data <- Read10X(data.dir = "~/NR_JK_045/filtered_feature_bc_matrix")
P001.data <- Read10X(data.dir = "~/NR_JK_013/filtered_feature_bc_matrix")
P002.1.data <- Read10X(data.dir = "~/NR_JK_014/filtered_feature_bc_matrix")
P002.2.data <- Read10X(data.dir = "~/NR_JK_015/filtered_feature_bc_matrix")
P003.data <- Read10X(data.dir = "~/NR_JK_016/filtered_feature_bc_matrix")
...
URINEList <- list(P005, P006, P007, P017.1, P017.2, P018.1, P018.2, P019.1, P019.2, P021, P022, P023.1, P023.2, P023.3, P023.4, P024.1, P024.2, P001, P002.1, P002.2, P003, P00812neg, P00812pos, P01316neg, P01316pos, FluriP0Pool1, FluriP0Pool2, FluriP0Pool3, FluriP0Pool4)
...
URINE$RRT <- NA
URINE$AKI_etiology <- NA
URINE$AKI_timepoint.main <- NA
URINE$AKI_timepoint.fine <- NA

## load clinical data ----
clin.data <- read.delim("~/AKIscRNAseqPL.csv", sep = ";")
...
for (i in clin.data$sample.pseudonym) {
  ...
  URINE@meta.data[URINE@meta.data$orig.ident %in% i, ]$COVID19_infection <- clin.data$disease[clin.data$sample.pseudonym %in% i]
  URINE@meta.data[URINE@meta.data$orig.ident %in% i, ]$CKD <- clin.data$CKDgrade[clin.data$sample.pseudonym %in% i]
  URINE@meta.data[URINE@meta.data$orig.ident %in% i, ]$KDIGO_AKI_stage <- clin.data$AKIN[clin.data$sample.pseudonym %in% i]
