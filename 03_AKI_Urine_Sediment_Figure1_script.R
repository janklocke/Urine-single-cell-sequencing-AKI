...
# This is the R script for generating Figure 1 and Supplemental Figure 4, 5 in 
...
## Compile and save, Suppl. Fig. 4 plots ----
...
## function for Suppl. Fig. 5 ----
# this function compares the absolute amount of a cell type /cluster between male and female patients
comparison_plots2 <- function(SO, xa, xn, ygroup, ya) {
  groups <- levels(factor(SO@meta.data[[xn]]))
  my_comparisons <- list(groups[1:2])
...
## compile and save ----
pw6 <- comparison_plots2(URINE, gender, "gender", cellgroup, TEC)+
  comparison_plots2(URINE, gender, "gender", cellgroup, PDC)+
  comparison_plots2(URINE, gender, "gender", cellgroup, LEUK)+
  comparison_plots2(URINE, gender, "gender", cellgroup, UGEC)+
  plot_layout(widths=c(1,1,1,1),guides="collect")
ggsave(plot = pw6, "supplfig5sex.png", h = 1300, w = 4200, units = "px", scale = 1, type = "cairo-png")
